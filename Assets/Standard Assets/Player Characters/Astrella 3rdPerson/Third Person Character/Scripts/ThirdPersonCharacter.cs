...
public class ThirdPersonCharacter : MonoBehaviour {
	...
	{ 
		...
		Vector3 airMove = new Vector3 (moveInput.x* airControl, 0, moveInput.z * airControl );
		...
		*/
		...
		float extraGravityForce = (Physics.gravity.y * gravityMultiplier) - Physics.gravity.y;
