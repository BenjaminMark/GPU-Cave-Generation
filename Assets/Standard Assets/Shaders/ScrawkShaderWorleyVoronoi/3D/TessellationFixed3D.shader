...
shader "Noise/TessellationFixed3D" 
{
    Properties 
    {
    ...
    SubShader 
    {
        ...
        {
            float d = fBm_F0(v.vertex.xyz, OCTAVES) * _Displacement;
            
            //float d = fBm_F1_F0(v.vertex.xyz, OCTAVES) * _Displacement;
        ...
        void surf(Input IN, inout SurfaceOutput o) 
        {
        	...
        	float noise = fBm_F0(objectPos, OCTAVES);
        	
        	//float noise = fBm_F1_F0(objectPos, OCTAVES);
