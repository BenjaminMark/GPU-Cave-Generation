//  www.slindev.com 
Shader "Custom/Transparent Cutout/BurningPaper"
{
        ...
        Pass
        {
            ...
            CGPROGRAM
...

                {
					...
					o.texcoord.xy = v.texcoord.xy;//http://shattereddeveloper.blogspot.dk/2011/09/handling-texture-tiling-and-offset-in.html
					
                    o.texcoord2.xy = TRANSFORM_TEX(v.texcoord, _MainTex);// * unity_LightmapST.xy + unity_LightmapST.zw;
